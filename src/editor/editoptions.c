...
edit_options_dialog (WDialog *h)
{
...

    {
        quick_widget_t quick_widgets[] = {
            ...
            QUICK_CHECKBOX (N_ ("&Backspace through tabs"), &edit_options.backspace_through_tabs,
                            NULL),
            QUICK_CHECKBOX (N_ ("Fill tabs with &spaces"), &edit_options.fill_tabs_with_spaces,
                            NULL),
            ...
            QUICK_CHECKBOX (N_ ("&Return does autoindent"), &edit_options.return_does_auto_indent,
                            NULL),
            ...
            QUICK_CHECKBOX (N_ ("Pers&istent selection"), &edit_options.persistent_selections,
                            NULL),
            QUICK_CHECKBOX (N_ ("Cursor be&yond end of line"), &edit_options.cursor_beyond_eol,
                            NULL),
