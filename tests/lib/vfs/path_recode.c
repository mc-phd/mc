...
static const struct test_path_recode_ds
{
    ...
    { /* 0. */
      "UTF-8", "/ÔÅÓÔÏ×ÙÊ/ÐÕÔØ", "/ÔÅÓÔÏ×ÙÊ/ÐÕÔØ", "/ÔÅÓÔÏ×ÙÊ/ÐÕÔØ" },
    { /* 1. */
      "UTF-8", "/#enc:KOI8-R/Ñ‚ÐµÑÑ‚Ð¾Ð²Ñ‹Ð¹/Ð¿ÑƒÑ‚ÑŒ", "/ÔÅÓÔÏ×ÙÊ/ÐÕÔØ",
      "/#enc:KOI8-R/Ñ‚ÐµÑÑ‚Ð¾Ð²Ñ‹Ð¹/Ð¿ÑƒÑ‚ÑŒ" },
    { /* 2. */
      "KOI8-R", "/Ñ‚ÐµÑÑ‚Ð¾Ð²Ñ‹Ð¹/Ð¿ÑƒÑ‚ÑŒ", "/Ñ‚ÐµÑÑ‚Ð¾Ð²Ñ‹Ð¹/Ð¿ÑƒÑ‚ÑŒ",
      "/Ñ‚ÐµÑÑ‚Ð¾Ð²Ñ‹Ð¹/Ð¿ÑƒÑ‚ÑŒ" },
    { /* 3. */
      "KOI8-R", "/#enc:UTF-8/ÔÅÓÔÏ×ÙÊ/ÐÕÔØ", "/Ñ‚ÐµÑÑ‚Ð¾Ð²Ñ‹Ð¹/Ð¿ÑƒÑ‚ÑŒ",
...
static const struct test_path_to_str_flags_ds
{
    ...
    { /* 1. */
      "/test1://user:passwd@host.name/#enc:KOI8-R/Ñ‚ÐµÑÑ‚Ð¾Ð²Ñ‹Ð¹/Ð¿ÑƒÑ‚ÑŒ", VPF_NONE,
      VPF_STRIP_PASSWORD, "/test1://user@host.name/#enc:KOI8-R/Ñ‚ÐµÑÑ‚Ð¾Ð²Ñ‹Ð¹/Ð¿ÑƒÑ‚ÑŒ" },
    { /* 2. */
      "/test1://user:passwd@host.name/#enc:KOI8-R/Ñ‚ÐµÑÑ‚Ð¾Ð²Ñ‹Ð¹/Ð¿ÑƒÑ‚ÑŒ", VPF_NONE, VPF_RECODE,
      "/test1://user:passwd@host.name/ÔÅÓÔÏ×ÙÊ/ÐÕÔØ" },
    { /* 3. */
      "/test1://user:passwd@host.name/#enc:KOI8-R/Ñ‚ÐµÑÑ‚Ð¾Ð²Ñ‹Ð¹/Ð¿ÑƒÑ‚ÑŒ", VPF_NONE,
      VPF_RECODE | VPF_STRIP_PASSWORD, "/test1://user@host.name/ÔÅÓÔÏ×ÙÊ/ÐÕÔØ" },
    { /* 4. */
      "/mock/home/test/dir", VPF_NONE, VPF_STRIP_HOME, "~/test/dir" },
    { /* 5. */
      "/mock/home/test1://user:passwd@host.name/#enc:KOI8-R/Ñ‚ÐµÑÑ‚Ð¾Ð²Ñ‹Ð¹/Ð¿ÑƒÑ‚ÑŒ", VPF_NONE,
    ...
    { /* 7. */
      "/mock/home/test1://user:passwd@host.name/#enc:KOI8-R/Ñ‚ÐµÑÑ‚Ð¾Ð²Ñ‹Ð¹/Ð¿ÑƒÑ‚ÑŒ", VPF_NONE,
      VPF_STRIP_HOME | VPF_RECODE, "~/test1://user:passwd@host.name/ÔÅÓÔÏ×ÙÊ/ÐÕÔØ" },
    { /* 8. */
      "/mock/home/test1://user:passwd@host.name/#enc:KOI8-R/Ñ‚ÐµÑÑ‚Ð¾Ð²Ñ‹Ð¹/Ð¿ÑƒÑ‚ÑŒ", VPF_NONE,
      VPF_STRIP_HOME | VPF_RECODE | VPF_STRIP_PASSWORD, "~/test1://user@host.name/ÔÅÓÔÏ×ÙÊ/ÐÕÔØ" },
};
/* *INDENT-ON* */
