...
static const struct test_deserialize_incorrect_ds
{
    ...
    { 's', "incorrect string", 0, /* FIXME, TODO */
      "mc_serialize_str(): String prefix doesn't equal to 's'" },
    { 's', "s12345string without delimiter", 0, /* FIXME, TODO */
    ...
    { 's', "s500:actual string length less that specified length", 0, /* FIXME, TODO */
